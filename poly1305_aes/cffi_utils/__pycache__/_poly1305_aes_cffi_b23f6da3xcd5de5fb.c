...
static struct PyModuleDef _cffi_module_def = {
  ...
  "_poly1305_aes_cffi_b23f6da3xcd5de5fb",
  NULL,
  -1,
  _cffi_methods,
  NULL, NULL, NULL, NULL
...
PyMODINIT_FUNC
PyInit__poly1305_aes_cffi_b23f6da3xcd5de5fb(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_poly1305_aes_cffi_b23f6da3xcd5de5fb(void)
{
  PyObject *lib;
  lib = Py_InitModule("_poly1305_aes_cffi_b23f6da3xcd5de5fb", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
